...
public class Options {
	...
	public Options(boolean aSeparatorSwitch,
			Separators aSeparator, Numberings aNumberings,
			int aFontSize) {
	...
	public String toString() {
		return String.format("separator: %s, sep: %s, format: %s, fontSize: %d", 
